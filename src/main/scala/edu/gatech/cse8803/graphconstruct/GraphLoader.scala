...
object GraphLoader 
{
    ...
    /*
    val loincVertices = null
    val loincRelationEdges = null

    val snomedVertices = null
    val snomedEdges = null
    val snomedDescendantEdges = null
    val snomedRelationEdges = null

    val rxnormVertices = null
    val rxnormEdges = null
    val rxnormDescendantEdges = null
    val rxnormRelationEdges = null

    val patlabEdges = null
    val labpatEdges = null
    val patdiagEdges = null
    val diagpatEdges = null

    val medicationEdges = null
    val revMedicationEdges = null
    */
    ...
    val edges = edges1.union(patdiagEdges).union(diagpatEdges).union(snomedEdges).union(snomedDescendantEdges).union(patlabEdges).union(labpatEdges).union(medicationEdges).union(rxnormEdges).union(rxnormDescendantEdges).union(revMedicationEdges)
    println("Edges Done")
