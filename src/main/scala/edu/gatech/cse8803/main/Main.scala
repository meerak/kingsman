...
object Main {
  ...
  def loadRddRawData(sqlContext: SQLContext): (RDD[PatientProperty], RDD[Medication], RDD[Observation], RDD[Diagnostic]) = {
    ...
    val labResults = lab_data.map(l => Observation(toInt(l(0).toString), toInt(l(1).toString), toInt(l(2).toString), l(3).toString, l(4).toString, toFloat(l(5).toString), l(6).toString, toInt(l(7).toString), toInt(l(8).toString), toFloatt(l(9).toString), toFloat(l(10).toString), toInt(l(11).toString), toInt(l(12).toString), toInt(l(13).toString), toInt(l(14).toString), l(15).toString, l(16).toString))
